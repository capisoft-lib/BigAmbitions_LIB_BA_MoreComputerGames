# English monitor examples

Direct 1920×1080 renders from the MCG launcher in an isolated Unity 2022.3.62f2 scene:

- `mcg-menu.en.png`: installed-game menu with Brick Breaker selected.
- `mcg-flappy-selected.en.png`: FlappyAmbition selected, with description and local best score.
- `mcg-loading.en.png`: loading state before gameplay is created.
