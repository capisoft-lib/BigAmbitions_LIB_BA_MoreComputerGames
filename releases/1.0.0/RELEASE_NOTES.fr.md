...
- Le bouton natif pour quitter conserve son texte traduit et ajoute **[TAB]** dans le menu MCG et les jeux. Son action ne change pas ; l'indication et l'ajustement temporaire du texte sont retirés à la fin de la session.
...
**Pour les auteurs de jeux :** recompiler les mods compatibles contre MCG **1.0.0**, assembly **1.0.0.0**. Le chargeur natif peut refuser les binaires référençant encore la version majeure 0, même si les signatures sont conservées. Déclarer MCG comme dépendance Workshop séparée, sans incorporer sa DLL.
